...
SEXP C_write_data_frame_list(SEXP df_list, SEXP file, SEXP col_names, SEXP format_headers, SEXP use_zip64, SEXP freeze_panes){
  ...
  assert_that(Rf_isLogical(freeze_panes), "freeze_panes must be logical");
